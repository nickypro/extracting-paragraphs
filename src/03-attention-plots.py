...
plt.savefig("attention_scores_mean_heatmap.png", dpi=600)
plt.show()
...
def plot_layer_metrics_overlay_layers(m, df, layers_to_plot=None, n_cols=4):
...
plot_layer_metrics_overlay_layers(m, orig_df, layers_to_plot=[0,5,11,17,23,29,35,41], n_cols=4)
plt.savefig("attention_cossim_heatmap_layers_8.png", dpi=600)
plt.show()

plot_layer_metrics_overlay_layers(m, orig_df, n_cols=4)
plt.savefig("attention_cossim_heatmap_layers_42.png", dpi=600)
plt.show()
# %%
